...
All notable changes to `checky-monkey` will be documented in this file.
...
- fix(ci): adopt canonical hypatia-scan.yml (#23)
- fix(ci): Phase-2 fleet submission must not fail the security gate (#22)
...
- ci(dependabot): restore cargo PR limit so security PRs flow (#17)
