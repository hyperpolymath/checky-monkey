{
  description = "checky-monkey - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P checky-monkey.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/checky-monkey $out/bin/  # Rust
            # cp bin/checky-monkey $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/checky-monkey";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-checky-monkey" {
